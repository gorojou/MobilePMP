...
namespace mobilePMP.ViewModels
{
    public class TransferTokenViewModel : BaseViewModel
    {
        ...
        )
        {
            ...
            _gasPrice = Web3.Convert.FromWei(TransactionBase.DEFAULT_GAS_PRICE, UnitConversion.EthUnit.Gwei);
        ...
        private async Task LoadDataAsync()
        {
            ...
            if (error)
            {
                ...
                var result = page.DisplayAlert("Error", "no se puede cargar las cuentas", "OK");
            }
        ...
        {
            return
                $"Estas seguro que deseas transferir?: \n\r a: {ToAddress} \n\r monto: {Amount}";
        }
        ...
        private async Task ExecuteAsync()
        {
            ...
            if (confirmed)
            {
                ...
                if (error)
                {
                    //todo rxui
                    var page = new ContentPage();
                    await page.DisplayAlert("Error", "No se puede transferir :" + exceptionMessage, "OK");
                }
